...
namespace MySoapConsumer.ServiceReference1 {
    ...
    public partial class Temperature : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private MySoapConsumer.ServiceReference1.TemperatureUnit UnitField;
        ...
        public MySoapConsumer.ServiceReference1.TemperatureUnit Unit {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference1.IUnitConversion")]
    public interface IUnitConversion {
        ...
        MySoapConsumer.ServiceReference1.Temperature ConvertTemp(MySoapConsumer.ServiceReference1.Temperature temp);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUnitConversion/ConvertTemp", ReplyAction="http://tempuri.org/IUnitConversion/ConvertTempResponse")]
        System.Threading.Tasks.Task<MySoapConsumer.ServiceReference1.Temperature> ConvertTempAsync(MySoapConsumer.ServiceReference1.Temperature temp);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUnitConversionChannel : MySoapConsumer.ServiceReference1.IUnitConversion, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UnitConversionClient : System.ServiceModel.ClientBase<MySoapConsumer.ServiceReference1.IUnitConversion>, MySoapConsumer.ServiceReference1.IUnitConversion {
        ...
        public MySoapConsumer.ServiceReference1.Temperature ConvertTemp(MySoapConsumer.ServiceReference1.Temperature temp) {
            return base.Channel.ConvertTemp(temp);
        }
        
        public System.Threading.Tasks.Task<MySoapConsumer.ServiceReference1.Temperature> ConvertTempAsync(MySoapConsumer.ServiceReference1.Temperature temp) {
